...
namespace IIS.1235
{
    ...
    public class График : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.1235.Табель fТабель;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.1235.Табель.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Табель"})]
        public virtual IIS.1235.Табель Табель
        {
            get
            {
                ...
                IIS.1235.Табель result = this.fТабель;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ГрафикE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ГрафикE", typeof(IIS.1235.График));
                }
            }
        }
    }
    ...
    public class DetailArrayOfГрафик : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.1235.DetailArrayOfГрафик members)

        // *** End programmer edit section *** (IIS.1235.DetailArrayOfГрафик members)
        ...
        /// </summary>
        public DetailArrayOfГрафик(IIS.1235.Табель fТабель) : 
                base(typeof(График), ((ICSSoft.STORMNET.DataObject)(fТабель)))
        {
        }
        
        public IIS.1235.График this[int index]
        {
            get
            {
                return ((IIS.1235.График)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.1235.График dataobject)
        {
